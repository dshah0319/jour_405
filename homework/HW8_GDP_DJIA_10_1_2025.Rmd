...
gdp_data |> 
  ...
  labs(title = "Relationship Between GDP and DJIA from 2013 to 2024" , x="GDP" , y = "DJIA")
```
...
The scatterplot depicts a positive correlation between GDP and the DJIA, which means that as GDP increases, the DJIA generally rises as well. The relationship starts off somewhat strong and then gets weaker at higher GDP levels, as the data points get more dispersed and not clustered around the relationship line.  
