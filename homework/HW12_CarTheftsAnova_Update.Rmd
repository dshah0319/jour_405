...
**Based on the results from calculating the rates of car theft from each period, the data shows that the average number of car thefts significantly increased from pre-spike to spike year (the mean increased from around 217 thefts to 573). The data shows that the average number of thefts decreased in the post spike period, but the average is still close to double the amount of the pre-spike period. This suggests that the spike led to a higher rate of car thefts in the post-spike period, but also the difference in the sample sizes between pre and post spike is pretty large which is important to take into consideration as well. **: The median rate nearly tripled from the 22.2 in the pre-spike to 58.1 in the spike year but the sample sizes varied a great deal, with 71 observations in pre-spike versus 12 in the spike year.
...
**The chart shows the number of car thefts monthly from 2017 to 2025 and displays how the numbers gradually increased from 2022 and reached its peak during the spike year and then began to decrease. A new title for the chart could be: Car Theft Rates Nearly Double Post 2023 Spike.  **
...
- **Null Hypothesis (H0)**:   The mean car theft rates are the same across the three time periods

- **Alternative Hypothesis (H1)**: The mean car theft rates differ between the three time periods
...
**There is a real difference in the average rates between the time periods and the result is statistically significant. The p-value is 2e-16 which is extremely small and much smaller than an alpha level, which leads us to reject the null hypothesis and conclude that there is strong evidence that the mean car theft rates differ significantly across the three time periods**
...
**The results of the Tukey test show that all of the p-values are 0 which means that every comparison is statistically significant. The difference between pre-spike and post-spike numbers is -20.13 which means that the car theft rates post spike were significantly higher than the numbers pre spike. The chart showing confidence intervals displays how the pre-spike period had the lowest mean and the post-spike period, while having a mean and interval that is smaller than the spike period, is still much higher than the pre-spike.
HL: Car theft rates remain far higher than before spike
An analysis of monthly car theft rates from 2017 to 2025 shows that despite thefts decreasing post the spike in car thefts in 2023, car theft rates are still almost double what they used to be in pre-spike years. Statistical testing found significant differences in the car theft rates between all three periods of time, and using the Tukey test, results showed a statistically significant difference in car rates between the pre and post spike periods, suggesting that the increase in car thefts during the spike had lasting effects. 
**