...
spotify_songs |> 
  ...
  labs(title = "Distribution of Danceability of Spotify Songs", x= "Danceability Scores", y="Number of Songs")
```
...
The distribution is not normal -- it is skewed to the left which means its a negative skew. This means that more songs cluster towards higher danceability values while fewer songs from the data have lower danceability scores. The mean danceability is 0.67 and the standard deviation is 0.16. This means that 68% of the data is between 0.51 and 0.83 in terms of their danceability value. 

This data shows that most songs on spotify are considered "danceable." A potential story could explore recent music trends and whether artists specifically try to produce a certain sound that increases the danceability score of their music.  
