...
**
For some of the racial/ethnic categories, there were not enough responses, so those identities were collapsed and combined into one single category, "Races/Ethnicities with Small Sample Sizes.” Having this collapsed category means that the experiences of a group are not accurately represented. 
Grouping nonbinary, genderfluid, and transgender students into one category called gender expansive also rasies methodological concerns. If a student is transgender, and they identify as male or female, shouldn't they be counted in those categories, instead of relegated to the broad 'gender expansive' category? The gender expansive category also runs the same risk as the first problem identified -- individual experiences and identities will not be accurately represented in the survey's data.
Another unclear or methodological concern is that international student status was only used for graduate students, even though there definitely is a segment of the undergraduate student population that would identify as an international student. 
...
1. What is the range of weights in this dataset? **The range of weights is 2.81**

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **When a respondent has a weight of 0.23, that probably means that they are overrepresented, whereas if a respondent has a weight of 3.04, they are probably underrepresented within the population.**

3. Why might some respondents be weighted more heavily than others? **Some respondents may be weighted more heavily than others because historically they might not have been a consistent voter, their location might play a factor, **
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **The 'rarely/never' voter category showed the biggest difference between weighted and unweighted results. For the always and sporadic catergories, there wasn't an increase or decrease of more than 0.4 points in any answer, but for the rarely/never category, there was a 3.6 point difference in voters saying Yes, an almost 2 point different for  no and a 1.6 difference for unsure.**

2. How might these differences affect reporting on likely voter turnout? **Using unweighted data when reporting would probably make it seem as if there are more people who are going to vote yes, but after using the weighted data, you can see that there are less people who are considered rarely/never voters who would vote yes.   **

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **These differences likely exist because infrequent voters were under-represented in the unweighted sample. Once the statistics were modified to better reflect the population, their number of yes responses decreased.**
