...
The headline 'Majority Supports New City Policy' is not statistically justified because for the first poll statistic, the margin of error is 10%, this means support could actually be as low as 46.8% or as high as 57.2%. Similarly for the other poll scenarios of different sample sizes, the margin of error takes into account that percentages that are below the majority. 

An alternative headline could be 'Support for New City Policy is Split Within the Population.' 

## do og percentage times the margin of error and then subtracted and then added from the og percentage to find the lower and upper range.
...
## code to find the critical value
```{r}
...
Data from recent home sales back up local officials claims that the new light rail has increased property values in the neighborhood. The average price of a home has increased by 6.8%, from $285k to $304.5k. The construction of the new light rail has made access to transportation significantly easier for residents, making the journey into nearby cities faster and cheaper than it was before the existence of the transit line. The new line has also made the neighborhood an attractive option for commercial development. This is making the neighborhood a popular option people looking for an up and coming area to move to, increasing demand for homes and consequnetly increasing the property value of homes in the neighorhood. 
