...
**We can see that there is a weak positive relationship between the FARMS percentage and the math test scores.**
...
**I would say that this model is worth using because it provides a ton of different information that can be worked with and subsequently analyzed to help understand and evaluate data. By looking at the p-value and the adjusted r-squared we can see that the relationship between the FARMS percentage and math scores is not significant because the p-value is greater than .05 (the p-value is 0.1225) and the adjusted r-squared is not close to 100 at all.**
...
**White Marsh Elementary School has the largest negative residual (-45.83), as the predicted result was 71.93 and the actual percent that met or exceeded math scores was only 26.1%, which demonstrates that they are significantly under performing in math. **
...
**Based on the information from the model's results, I would conclude that there isn't a statistically significant enough relationship to confidently say that having an elementary school with fewer students on free and reduced meals do better on standardized math tests. A story pitch could be about how this school board member is drawing unsubstantiated conclusions about the relationship between FARMS percentages and math scores and how after analyzing data, there is no evidence to back up their claims.**
